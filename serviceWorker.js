// Worker        para proveer funcionalidad offline
//Web Manifest   para que pueda instalarse la web app
//Diseño responsivo
<script> 
...
service-worker.jsself.addEventListener('install', function() { console.log('Install!');});
